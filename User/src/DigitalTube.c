...
/*****路程各项进位*****/	
    left_move = Real_Location_Left;
		right_move = Real_Location_Right;

		total_move = (left_move + right_move)*0.35;
		...
		if(total_move == 50 || total_move == 75 || total_move == 120  || total_move == 240 || total_move == 468 || total_move == 500 || total_move == 752 || total_move == 862)
		{
